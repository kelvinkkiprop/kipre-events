...
<div class="breadcrumb">
    <div class="container">
        <div class="display-5 fw-bold text-light"><br><br><span class="fs-1">EVENT BOOKING</span></div>
    </div>
</div>
        ...
        <div class="row row-cols-1 row-cols-md-4 g-2">
                ...
                <div class="card border-0 h-100 rounded-0">
                    ...
                    <div class="card-footer bg-info">
                        <div class="text-center text-light">
                            <a href="/booking/1" class="h4  text-decoration-none text-reset">Apply Now</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card border-0 h-100 rounded-0">
                    ...
                    <div class="card-footer bg-info">
                        <div class="text-center text-light">
                            <a href="/booking/2" class="h4  text-decoration-none text-reset">Apply Now</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card border-0 h-100 rounded-0">
                    ...
                    <div class="card-footer bg-info">
                        <div class="text-center text-light">
                            <a href="/booking/3" class="h4  text-decoration-none text-reset">Apply Now</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card border-0 h-100 rounded-0">
                    ...
                    <div class="card-footer bg-info">
                        <div class="text-center text-light">
                            <a href="/booking/4" class="h4  text-decoration-none text-reset">Apply Now</a>
                        </div>
                    </div>
                </div>
            </div>
