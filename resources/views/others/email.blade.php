                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="{{ config('app.url') }}"
                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #066aab; font-size: 19px; font-weight: bold; text-decoration: none; display: inline-block;">
                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <h1
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 18px; font-weight: bold; margin-top: 0; text-align: left;">
                                            Dear {{ $data['name'] }},</h1>
                                        <p
                                                                        ...
                                                                        <tr>
                                                                            <td
                                                                                ...
                                                                                <a href="{{ $data['url'] }}"
                                                                                    ...
                                                                                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #066aab; border-bottom: 8px solid #066aab; border-left: 18px solid #066aab; border-right: 18px solid #066aab; border-top: 8px solid #066aab;">
                                                                                    {{ $data['btn-text'] }}</a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                        ...
                                                        <p
                                                            ...
                                                            into your web browser: <span class="break-all"
                                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; word-break: break-all;"><a
                                                                    class="my-a" href="{{ $data['url'] }}"
                                                                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3869d4;">{{ $data['url'] }}</a></span>
                                                        </p>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © {{ Date('Y') }}&nbsp;{{ config('app.name', 'Laravel') }}. All rights
                                            reserved.</p>
